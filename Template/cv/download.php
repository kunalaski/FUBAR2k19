...
echo '<a href=".$url."  class="w3-button w3-black w3-border w3-hover-border-black"> Visit your page</a>';
...
<?php
echo '<p class=" w3-button w3-pale-green w3-hover-pale-green w3-leftbar w3-hover-border- w3-border-green w3-xlarge" style="cursor:default">Check your mail for the source code</p>';
 ?>
 </div>
